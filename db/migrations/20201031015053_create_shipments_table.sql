...
CREATE TABLE `shipments` (
    ...
    `to_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '配達先の名前',
    ...
    `done_date_time` DATETIME COLLATE utf8mb4_bin COMMENT '配達完了時間',
    `qrmd5` varchar(255) COLLATE utf8mb4_bin COMMENT 'QRMD5',
